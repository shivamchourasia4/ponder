            ...
            <div class="info">
                <h1 class="logo"> 
                    ...
                    Ponder
                        ...
                        <p>Welcome to Ponder, a place to share all your thoughts on trending and your loved topics among everyone. See what everyone is pondering over and join them. So, what are you waiting for sign up and start pondering now!</p>
            			<img src="images/Followers-rafiki.svg" alt="">
            </div>
                <div class="card">
        <!-- logo -->
                    <h2>Sign in</h2>
                             <c:if test="${not empty wrongio}">
<%--          <c:if test="${fn:}"></c:if> --%>
         <div class="alert alert-danger">
         
  			<strong>Opps..! </strong> ${wrongio}
		 </div>
		</c:if> 
		<c:if test="${not empty check}">
			<div class="alert alert-success">
  			<strong>Yay!</strong>  You are now a part of ponder. Sign in and enjoy!
		 </div>
		</c:if>
		
                    <form class="card-form" action="Login" method="POST">
                        <input name="username" type="text" id="inputEmail" class="form-control" placeholder="Username or Email" required autofocus>
                        <input name="passkey" type="password" id="inputPassword" class="form-control" placeholder="Password" required>
                        <br>
                        <input type="submit" value="Sign in" class="btn btn-primary signin-btn">
                    </form>
                    <hr style="width: 50%;">
                    <h2>Don't have an account?</h2> 
  <button class="btn btn-primary" onclick="location.href='register.jsp'">Sign up</button>
...
<footer class="footer">
    <div class="details">
        <h1>Ponder</h1>
        <p>Developer : Shivam Chourasia</p>
