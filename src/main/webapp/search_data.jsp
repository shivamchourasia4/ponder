...
<%
		...
		try {
			String srctopic = (String) session.getAttribute("srchthis");
			ResultSet resultSet = model.Searchtopic(srctopic);
				...
				%>
				 <div class="container flex cards">
			        <div class="forpost flex">
			            <h3>No one is pondering over such topic.
			             Why don't you be the first!</h3>
			             <hr width="100%">
			        </div>
			    </div>
			<%
