    ...
    <div class="container">
        <div class="cover grid">
            ...
            <img src="images/Followers-pana.svg">
                ...
                <div class="card">
        <!-- logo -->
                    <h2>What is ponder?</h2>
                    <hr style="width: 50%;">
                   <div  style="padding: 20px;"><p>Ponder is a place to share all your thoughts and opinions about anything that you are pondering over.</p>
                   <p>See what everyone else is pondering over.</p> 
                   <p>Didn't see your relevant topics. Don't worry just use the search bar and have a look at other people's ponders on your interests.</p>
                   <p>Feeds with ponders of only your interested topics will be coming soon...</p>
                    <h3>See you on the other side!</h3>
                    <h4>Happy Pondering.</h4>
                   </div>
                    <hr style="width: 50%;">
                    <p>Positive vibes from the developer.</p> 
